...
exports.createStoryByChatGPT = async (req, res) => {
  try {
    ...
    6. Please generate story content "without any explanatory text" and do not include story title\n`;
    ...
    const titlePrompt =`What would be the title of the story? Please generate story title without any explanatory text or annoations:\n`
